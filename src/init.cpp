...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/batamcoin-project/batamcoin>";
    const std::string URL_WEBSITE = "<https://batamcoin.org>";
