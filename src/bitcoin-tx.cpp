...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s batamcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  batamcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded batamcoin transaction") + "\n" +
              "  batamcoin-tx [options] -create [commands]   " + _("Create hex-encoded batamcoin transaction") + "\n" +
              "\n";
