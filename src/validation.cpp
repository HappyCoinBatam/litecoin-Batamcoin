...
#if defined(NDEBUG)
# error "Batamcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Batamcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BAM additional fees, %d delta bytes\n",
