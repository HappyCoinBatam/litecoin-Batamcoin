Batamcoin Core version *0.15.1* is now available from:

  <https://download.batamcoin.org/batamcoin-0.15.1/>
...
A number of changes to the way Batamcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 batubesar per kB (0.00001 BAM). This is to prepare for dropping the minimum transaction fee to 0.1 batubesar per kB (0.0001 BAM) in the next release.
